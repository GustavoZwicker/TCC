...
<html>
    <head>
        ...
        <link href="/css/redacoes.css" rel="stylesheet">
    </head>
    <body>
        <div id=tela>
            <div id=headerph>
            ...
            <div id=rodape>
                <div class="row">
                    <div class="column">
                        <div class=rodapeinfo><img src="/img/logo_r.png">
                            <br>Contato: gustavo.zwicker@etec.sp.gov.br</br>
                        </div>
                    </div>
                    <div class="column">
                        <div class=rodapeinfo2>Copyright (c) - 2020 Vestibulando Informação e Vestibulares </br> </br>
